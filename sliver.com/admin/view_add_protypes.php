      ...
      <div class="content container-fluid">
        ...
        <div class="page-header">
          <div class="row align-items-center">
            <div class="col-sm mb-2 mb-sm-0">
              <h1 class="page-header-title">Add New Protypes</h1>
            </div>
          </div>
        </div>
        <!-- End Page Header -->
        ...
        <div class="widget-box">
					...
					<div class="widget-content nopadding">
						...
						<!-- BEGIN USER FORM -->
						<form action="./action/add/addProtypes.php" method="post" class="form-horizontal" enctype="multipart/form-data">
							<div class="control-group">
                <div class="control-group">
                  <label  for="fname">Protype name:</label>
                  <input type="text" id="fname" placeholder="input protype name" name = "type_name">
